...
PARAMETER {
	...
	celsius	= 36	(degC)
	en = -20		(mV)
	cai 	(mM)	: initial [Ca]i = 50 nM Changed this to remove it
	gbar	= 0	(mho/cm2)
	beta	= 0.00002:2.5	(1/ms)		: backward rate constant, significantly slower
	cac	= 0.75e-3:0.87e-3:0.33e-3:1e-3:1e-4	(mM)		: middle point of activation fct
